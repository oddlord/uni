...
\section*{LINFA: Smart drugs restocking}
  ...
  \subsection*{Smart drugs restocking}
    ...
    \answer{
      ...
      States from \prism{s=0} to \prism{s=2} (lines 38-47) are used to model the drug order for the current day (i.e. day 0). In particular, lines 43-47 represents all the possible orders that can be issued, modelled through non-deterministic choices. Also, each choice has a label associated, that will be used in the cost reward computation.
