...
\begin{tikzpicture}[node distance = \nodedistance, auto]
  ...
  \node [above = \nodemeasuredistance of ws4, align=center] (TTSN4) {$\scriptstyle TTSN_4$};
  ...
  \node [below = \pathopdistanceextra of ws3ws4, align=center] (ws3ws4-op) {$\scriptstyle\vee$};
  \path [line] (ws4) -- coordinate[midway] (ws4ws5) (ws5);
  \node [below = \pathopdistanceextra of ws4ws5, align=center] (ws4ws5-op) {$\scriptstyle\vee$};
  \path [line] (ws5) -- coordinate[midway] (ws5ws6) (ws6);
  \node [below = \pathopdistanceextra of ws5ws6, align=center] (ws5ws6-op) {$\scriptstyle\vee$};
