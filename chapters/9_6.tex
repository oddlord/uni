\section*{Esercizio 9.6}
    ...
    \enunciato{Si aggiunga al linguaggio SMALL un comando \textbf{stop} con la semantica informale di far terminare il programma. Se ne dia la semantica e si dimostri che $c_1;\mbox{\textbf{stop}}$ e $c_1;\mbox{\textbf{stop}};c_2$ sono semanticamente equivalenti.}
    ...
    \boxedaligned{0.7}{
        \mathcal{P}\doublebracket{\mbox{\textbf{program}}\; c}in =\; & ca\begin{aligned}[t] & \! ses\; (\mathcal{C}\doublebracket{c}\rho_0(\lambda x.unused)[in/lin][nil/lout])\; of\\
            & \sigma: \sigma\; lout;\\
            & error: error;\\
            & <stop, \sigma>: \sigma\; lout
        \end{aligned}\\
        & endcases
    }
